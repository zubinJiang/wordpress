...
<head profile="http://gmpg.org/xfn/11">
	...
	<meta name="google-site-verification" content="Qlkg0RpDb9LEkQNuDuVec9K04suDSaGUQzxHAOgYVF0" />
	<meta name="baidu-site-verification" content="vZIz8eKVaqxY2Dpa" />

	<meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php bloginfo('charset'); ?>" />
	<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
	<meta name="keywords" content="Yang, YangHome, zubinJiang, jiangzubin, zubinJiang的技术主页, jiangzubin的技术主页, PHP技术blog, <?php bloginfo('name'); ?><?php wp_title(); ?>;" />
	...
	<title><?php bloginfo('name'); ?> | 智慧在于共享和交流 | <?php wp_title(); ?> </title>
